    ...
    render() {
        return (
            <div className="table">
                ...
                <h3 className="pb-20">Management Users</h3>
                <Button color="primary" className="text-white" href="/create-user">CREATE</Button>
                <Table responsive striped>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><Button href="/edit-user" color="success">EDIT</Button>{' '}</td>
